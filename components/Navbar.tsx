    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-4 py-4">
      <div className="max-w-7xl mx-auto bg-white/80 backdrop-blur-md rounded-full px-6 py-3 bubbly-border flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 font-semibold text-[#1a1a1a]">
          <button onClick={onLogoClick} className="hover:text-orange-600 transition-colors">Home</button>
          <a href="#shop" className="hover:text-orange-600 transition-colors">Shop</a>
          <a href="#" className="hover:text-orange-600 transition-colors">Deals</a>
