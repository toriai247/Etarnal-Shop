      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 text-center md:text-left z-10">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            <a href="#shop" className="px-10 py-4 text-xl font-bold rounded-full btn-3d-orange text-white border-4 border-black inline-block">
              SHOP NOW
            </a>
            <button className="px-10 py-4 text-xl font-bold rounded-full bg-white text-black border-4 border-black shadow-[6px_6px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all">
              EXPLORE
            </button>
          </div>
        </div>
